...
Ptr<Char> StringData::operator[](const i32 aIndex)
{
	return myData[aIndex];
}

ConstPtr<Char> StringData::operator[](const i32 aIndex) const
{
	return myData[aIndex];
}

Ptr<Char> StringData::operator*()
{
	return *myData;
}

ConstPtr<Char> StringData::operator*() const
{
	return *myData;
}
